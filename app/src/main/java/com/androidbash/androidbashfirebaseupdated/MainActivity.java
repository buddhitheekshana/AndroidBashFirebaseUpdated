...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef = new Firebase("https://androidbash-6f92f.firebaseio.com/users/");
    ...
    protected void onStart() {
        ...
        changeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                goToUrl ( "http://bussup.jtours.netau.net/");
                myFirebaseRef.child("welcomeText").setValue("Android App Development @ 420Coders ");
            }
        });
        ...
        revertButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                myFirebaseRef.child("welcomeText").setValue("Welcome to BusSup");
            }
        });
